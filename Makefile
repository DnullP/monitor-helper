...
.PHONY: help build release run list usb-scan usb-watch get set profile capabilities scan probe-inputs cycle-inputs switch-dp switch-hdmi2 check fmt lint test clean
...
cycle-inputs:
	./scripts/cycle_input_values_forever.sh $(ARGS)
